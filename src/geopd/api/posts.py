...
@login_required
def get_posts():
    response = jsonapi.get_collection(db.session, request.args, 'core-posts')
...
def get_post(post_id):
    response = jsonapi.get_resource(db.session, request.args, 'core-posts', post_id)
    return jsonify(response.document), response.status
...
def get_core_post_comments():
    response = jsonapi.get_collection(db.session, request.args, 'core-post-comments')
    return jsonify(response.document), response.status
...
def create_core_post_comment():
    response = jsonapi.post_resource(db.session, request.args, request.get_json(), 'core-post-comments')
    return jsonify(response.document), response.status
...
def update_core_post_comment(post_id):
    response = jsonapi.patch_resource(db.session, request.args, request.get_json(), 'core-post-comments', post_id)
    return jsonify(response.document), response.status
...
def delete_core_post_comment(post_id):
    response = jsonapi.delete_resource(db.session, 'core-post-comments', post_id)
    return jsonify(response.document), response.status
...
def get_project_posts():
    response = jsonapi.get_collection(db.session, request.args, 'project-posts')
    return jsonify(response.document), response.status
...
def get_project_post(post_id):
    response = jsonapi.get_collection(db.session, request.args, 'project-posts', post_id)
    return jsonify(response.document), response.status
...
def create_project_post_comment():
    response = jsonapi.post_resource(db.session, request.args, request.get_json(), 'project-post-comments')
    return jsonify(response.document), response.status
...
def update_project_post_comment(post_id):
    response = jsonapi.patch_resource(db.session, request.args, request.get_json(), 'project-post-comments', post_id)
    return jsonify(response.document), response.status
...
def get_communication_post(post_id):
    response = jsonapi.get_collection(db.session, request.args, 'com-posts', post_id)
    return jsonify(response.document), response.status
...
def get_communication_post_comments():
    response = jsonapi.get_collection(db.session, request.args, 'com-post-comments')
    return jsonify(response.document), response.status
...
def create_communication_post_comment():
    response = jsonapi.post_resource(db.session, request.args, request.get_json(), 'com-post-comments')
    return jsonify(response.document), response.status
...
def update_communication_post_comment(post_id):
    response = jsonapi.patch_resource(db.session, request.args, request.get_json(), 'com-post-comments', post_id)
    return jsonify(response.document), response.status
